	...
	if (details.reason == 'update') {
		...
		switch (details.previousVersion) {
			case "0.1":
				...
				url = 'data:text/html,<h1>FeedlyPreviewWindow Updated!</h1><p>Feedly Background Window has been updated.  Please check the <a href="https://chrome.google.com/webstore/detail/feedly-preview-window/oodgcldmocgdhjeibiphdlippflhiiea">extension page</a> for more information.</p>';
				break;
		}
		if (url) {
			chrome.tabs.create({
